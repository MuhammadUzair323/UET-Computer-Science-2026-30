/*
                   Project for AICT :
                        Pawsome PETS & Co, Application
                   Problem:
                        Animal shelters struggle to manage pet records, track donations, and facilitate adoptions efficiently
                   without dedicated software. Manual record-keeping is error-prone and makes it difficult to search,
                   sort, or update pet data quickly. Furthermore, financial transparency knowing how much has been
                   donated versus earned through adoption fees is often lacking. PAW-SOME addresses these
                   challenges by providing a structured, menu-driven CLI application that any shelter volunteer can use
                   without technical expertise
                   Features:
                        This application provides various features for the admin. customer and donator. It provides extensive
                   manupilation for the data incoming for a donation shelter
                   language:
                        Made using only C++ and in VSCode

                                               """This is a very personal and unique idea
                                                       Made for the Loving mention
                                                           of my pet cat 'Taun' """"
*/
#include <iostream>
#include <fstream>
